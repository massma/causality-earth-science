...
\ref{fig:generic}). For example, we generally do not observe the state
space at every time (e.g. $S(t-1/2)$ in Figure \ref{fig:generic}), and
...
$E$ in Figure \ref{fig:generic}), then the causal effect will be
