...
forcing, atmospheric humdity, etc. For radiation, this includes
...
independent of each other. The representation of ramdomness in causal
...
representation is more intuitive to domain experts, so we focus on
graph-based theory in our application of causal inference to earth
science.
...
data were not available or one where very naive, one approach would be
...
\item In order to calculate an unbiased causal effect from data, we
  must isolate the covariability between causal and effect that is due
